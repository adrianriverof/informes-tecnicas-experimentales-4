...
\end{figure}
	...
	Para obtener las medidas de longitud del capilar, lo llenamos de agua, lo pesamos varias veces y calculamos la media, para reducir el error, que devemos calcular según su desviación típica:
	...
	De modo que $m_{capilar} = 45,64 \pm 0,02 \si{g}$
